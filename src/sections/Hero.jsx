...
//rafce react shortcut to create component
const Hero = () => {
  const [bigShoeImg, setBigShoeImg] = useState(bigShoe2);
  return (
    // Here justify-center container works coz flex-col is used
    <section className='w-full flex xl:flex-row flex-col justify-center min-h-screen gap-10 max-container'>
      <div className='relative xl:w-2/5 flex flex-col justify-center items-start w-full  max-xl:padding-x pt-28'>
          ...
          <h1 className=' text-8xl max-sm:text-[72px] mt-10 font-palanquin max-sm:leading-[82px] font-bold'>
      ...
      <div className='relative flex-1 flex justify-center items-center xl:min-h-screen max-xl:py-40 bg-primary bg-hero bg-cover bg-center'>
        ...
        />
        <div className='flex sm:gap-6 gap-4 absolute -bottom-[5%] max-sm:px-6 sm:left-[10%]'>
